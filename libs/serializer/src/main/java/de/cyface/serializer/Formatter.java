...
public class Formatter {
     ...
     * Converts the number into the format expected by the Cyface ProtoBuf serializer.
     *
     * @param meters the speed in m, e.g.: 3.0m
     * @return the formatted number, e.g. 3_00 cm
     */
    private static int accuracy(double meters) {
        final long converted = Math.round(meters * 100.);
        Validate.isTrue(converted <= Integer.MAX_VALUE);
        return (int)converted;
    }
    ...
    /**
     * Geolocation attributes in the format and units expected by the Cyface Protobuf serializer.
     *
     * @author Armin Schnabel
     * @version 1.0.0
     * @since 5.0.0
    ...
    public static class Location {
         ...
         * @param accuracy the accuracy in m
         */
        public Location(long timestamp, double latitude, double longitude, double speed, double accuracy) {
            ...
            this.accuracy = Formatter.accuracy(accuracy);
        }
    ...
    /**
     * Point 3d attributes in the format and units expected by the Cyface Protobuf serializer.
     *
     * @author Armin Schnabel
     * @version 1.0.0
     * @since 5.0.0
